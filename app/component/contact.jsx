    ...
    return(
        <div className='contain'>
            ...
            <div className='policy'>
                <div ><Link href="policy.txt" className='policy'>Privaicy policy</Link></div>
            </div>
        ...
        <div className="contact">
            ...
            <div className='icons'><a href="https://www.facebook.com/"><FaFacebook size={40} color='silver'/></a>
            <a href="https://www.instagram.com"><FaInstagram size={40} color="silver"/></a>
            <a href="https://www.twitter.com"><FaTwitter size={40} color="silver"/></a>
            <a href="https://www.discord.com"><FaDiscord size={40} color="silver"/></a></div>
